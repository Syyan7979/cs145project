...
def InputParsing():
    ...
    parser.add_argument('-c', 'sender_Port', metavar='', type=int, help = "denotes the port used by the sender; this port is assigned per student, given at the same time as the unique ID (6707)", default = 6707)
    parser.add_argument('-i', 'unique_ID', metavar='', type=str, help = "denotes the unique ID; this ID is assigned per student, given at the same time as the port assigned to the student (default value: 09cfd2c6)", default = '09cfd2c6')
